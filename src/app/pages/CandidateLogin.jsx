        ...
        >
          ...
          <button
                  ...
                  onClick={() => {
                    ...
                    window.location.href = "https://api-rig-jobs.easybizcart.com/public/api/auth/google";

                  }}
                  className="w-full flex items-center justify-center space-x-3 border border-border bg-white hover:bg-gray-50 text-foreground py-3 rounded-xl font-medium text-sm transition-all hover:shadow-sm"
                >
